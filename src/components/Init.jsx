...
const Init = () => {
    return (
        <div className="flex flex-col items-center w-full bg-sky-100">
            ...
            <h1 className="text-bg-slate-500 font-semibold text-1xl mt-14">Sistema de monitoreo y control de flujo de agua en el laboratorio de Sistemas Telemáticos</h1>
        </div>
    )
}
