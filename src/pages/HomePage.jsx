...
const HomePage = () => {
    ...
    return (
        <div className="flex">
            <div className={`bg-sky-800 h-screen w-10 p-5 pt-8 pl-1 ${open ? "w-60" : "w-20"}
            duration-300 relative`}>
                ...
                <div className='inline-flex'>
                    <img
                        ...
                        src={fot}
                    />
                    <h1 className={`text-black origin-left font-medium font-mono text-2xl ${!open && "scale-0"}`}>Home</h1>
                </div>
                <div>
                    <ul className='pt-2'>
